...
DATASET_URL = "https://example.com/smoke_video_dataset.tar.gz"
DOWNLOAD_PATH = "/workspaces/FIREPREVENTION/data/raw"
EXTRACT_PATH = "/workspaces/FIREPREVENTION/data/raw/smoke_detection"
...
if __name__ == "__main__":
    file_path = os.path.join(DOWNLOAD_PATH, "smoke_video_dataset.tar.gz")
